...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Escribe un resultado de correo certificado en Azure SQL."
    )
    parser.add_argument(
        "--input",
        required=True,
        help="Ruta al JSON de resultado de procesador_correo.py",
    )
...
def main() -> int:
    ...
    summary = write_correo_result_to_sql(args.id_archivo, result)
